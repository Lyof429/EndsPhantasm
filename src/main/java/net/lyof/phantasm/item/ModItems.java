...
public class ModItems {
    ...
    public static final Item POLYPPIE_SPAWN_EGG = ModRegistry.ofItem("polyppie_spawn_egg",
            ...
            .build();
    public static final Item SOUR_SLUDGE_SPAWN_EGG = ModRegistry.ofItem("sour_sludge_spawn_egg",
                    new SpawnEggItem(ModEntities.SOUR_SLUDGE, 0xca2656, 0x5d2a4d, new FabricItemSettings()))
            .build();
}
